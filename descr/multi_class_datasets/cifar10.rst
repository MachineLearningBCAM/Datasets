...
Attribute Information: 
    ...
    ViT_B_16 network: The 1000 attributes correspond to the second last layer of a ViT_B_16 model pretrained on ImageNet Data Set used to predict the class of each image on Cifar10 dataset.
