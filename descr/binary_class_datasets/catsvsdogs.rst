...
Attribute Information: 
    ...
    ViT_B_16 network: The 768 attributes correspond to the second last layer of ViT_B_16 model pretrained on ImageNet Data Set used to predict the class of each image on Cats vs Dogs dataset.
